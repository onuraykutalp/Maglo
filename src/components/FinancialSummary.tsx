...
const FinancialSummary: React.FC<Props> = ({ summary }) => {
  ...
  return (
    <div className="py-2 w-full">
      ...
      {/* Total Balance */}
      <div className="bg-[#363a3f] rounded-xl shadow p-2 sm:p-3 md:p-4 h-[125px] flex flex-row items-center transition-transform duration-200 hover:scale-105 hover:shadow-lg cursor-pointer">
      ...
      {/* Total Expense */}
      <div className="bg-[#f8f8f8] rounded-xl shadow p-2 sm:p-3 md:p-4 h-[125px] flex flex-row items-center transition-transform duration-200 hover:scale-105 hover:shadow-lg cursor-pointer">
